...
The local app is `dist/Todora.app`; the packaging script also creates `dist/Todora.dmg` and signs the app ad hoc. The DMG and checksum are available in the [0.11.1 release](https://github.com/oliverlukschander/todora/releases/tag/v0.11.1).
