...
filtering and volume follow tyre load and slide. `tyres.s16le` is headerless PCM.
...
The sci-fi propulsion sound is synthesized by Todora; no engine recordings.
