...
pub(crate) const MODEL: &str = "models/vantage_gte_95.glb";
...
fn attach_wheels(
    ...
    for entity in children.iter_descendants(ready.entity) {
        ...
        // `make_vantage_gte.py` names the hubs WheelFL, WheelFR, WheelRL, WheelRR.
...
/// name comes from the material in `make_vantage_gte.py`, so the model says
