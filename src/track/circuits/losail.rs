...
//! GPS from bacinger/f1-circuits `394d8fbe70ef`, id `qa-2004`
//! (5.427 km). Heights from the Open-Meteo DEM, sampled at those same fixes.
//! Turned to begin at the start/finish line, 25.48908, 51.44968.
