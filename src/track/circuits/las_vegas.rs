...
//! GPS from bacinger/f1-circuits `394d8fbe70ef`, id `us-2023`
//! (6.228 km). Heights from the Open-Meteo DEM, sampled at those same fixes.
//! Turned to begin at the start/finish line, 36.1099, -115.1612.
