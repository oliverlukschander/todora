...
//! GPS from bacinger/f1-circuits `394d8fbe70ef`, id `sg-2008`
//! (4.948 km). Heights from the Open-Meteo DEM, sampled at those same fixes.
//! Turned to begin at the start/finish line, 1.29173, 103.86414.
