...
pub(crate) const TABLE: &[Entry] = &[
    ...
    ("pause.hint", ["↑ ↓ / W S / D-pad / Stick  Select\nEnter / A  Confirm · Esc / B / Start  Resume", "↑ ↓ / W S / Steuerkreuz / Stick  Wählen\nEnter / A  Bestätigen · Esc / B / Start  Weiter", "↑ ↓ / W S / Croix / Stick  Choisir\nEntrée / A  Valider · Échap / B / Start  Reprendre", "↑ ↓ / W S / Cruceta / Stick  Elegir\nIntro / A  Confirmar · Esc / B / Start  Continuar", "↑ ↓ / W S / Croce / Levetta  Scegli\nInvio / A  Conferma · Esc / B / Start  Riprendi"]),
    ...
    ("title.hint", ["↑ ↓ / W S  Choose     Enter / A  Go", "↑ ↓ / W S  Wählen     Enter / A  Los", "↑ ↓ / W S  Choisir     Entrée / A  Go", "↑ ↓ / W S  Elegir     Intro / A  Vamos", "↑ ↓ / W S  Scegli     Invio / A  Via"]),
    // The countdown.
    ...
    ("settings.hint", [
        "↑ ↓ / W S  Choose    ← → / A D  Change    LB / RB  or  Q / E  Tab\nEsc / B  Back",
        "↑ ↓ / W S  Wählen    ← → / A D  Ändern    LB / RB  oder  Q / E  Reiter\nEsc / B  Zurück",
        "↑ ↓ / W S  Choisir    ← → / A D  Modifier    LB / RB  ou  Q / E  Onglet\nÉchap / B  Retour",
        "↑ ↓ / W S  Elegir    ← → / A D  Cambiar    LB / RB  o  Q / E  Pestaña\nEsc / B  Volver",
        "↑ ↓ / W S  Scegli    ← → / A D  Cambia    LB / RB  o  Q / E  Scheda\nEsc / B  Indietro",
    ]),
...
pub(crate) const MORE: &[Entry] = &[
    ...
    ("board.hint", [
        "← → / A D  Circuit    ↑ ↓ / W S  Row    Q / E  or  LB / RB  View\nA / Enter  Race ghost    X / P  Pin rival    Esc / B  Back",
        "← → / A D  Strecke    ↑ ↓ / W S  Zeile    Q / E  oder  LB / RB  Ansicht\nA / Enter  Gegen Geist fahren    X / P  Rivale merken    Esc / B  Zurück",
        "← → / A D  Circuit    ↑ ↓ / W S  Ligne    Q / E  ou  LB / RB  Vue\nA / Entrée  Affronter le fantôme    X / P  Épingler un rival    Échap / B  Retour",
        "← → / A D  Circuito    ↑ ↓ / W S  Fila    Q / E  o  LB / RB  Vista\nA / Intro  Correr contra el fantasma    X / P  Fijar rival    Esc / B  Volver",
        "← → / A D  Circuito    ↑ ↓ / W S  Riga    Q / E  o  LB / RB  Vista\nA / Invio  Sfida il fantasma    X / P  Fissa rivale    Esc / B  Indietro",
    ]),
    ...
    ("board.week_best", ["Your best this week: {}    ·    F / Y  Drive it", "Deine Bestzeit diese Woche: {}    ·    F / Y  Losfahren", "Votre meilleur temps cette semaine : {}    ·    F / Y  Y aller", "Tu mejor tiempo esta semana: {}    ·    F / Y  Conducir", "Il tuo migliore questa settimana: {}    ·    F / Y  Guida"]),
    ("board.week_none", ["No lap this week yet.    ·    F / Y  Drive it", "Diese Woche noch keine Runde.    ·    F / Y  Losfahren", "Pas encore de tour cette semaine.    ·    F / Y  Y aller", "Aún no hay vuelta esta semana.    ·    F / Y  Conducir", "Ancora nessun giro questa settimana.    ·    F / Y  Guida"]),
    ...
    ("replay.hint", [
        "A / Enter  Play    ← → / A D  Scrub    ↑ ↓ / W S  Speed    Q / E  Lap    Y  Camera    X / P  Photo    Esc / B  Back",
        "A / Enter  Abspielen    ← → / A D  Spulen    ↑ ↓ / W S  Tempo    Q / E  Runde    Y  Kamera    X / P  Foto    Esc / B  Zurück",
        "A / Entrée  Lire    ← → / A D  Défiler    ↑ ↓ / W S  Vitesse    Q / E  Tour    Y  Caméra    X / P  Photo    Échap / B  Retour",
        "A / Intro  Reproducir    ← → / A D  Avanzar    ↑ ↓ / W S  Velocidad    Q / E  Vuelta    Y  Cámara    X / P  Foto    Esc / B  Volver",
        "A / Invio  Riproduci    ← → / A D  Scorri    ↑ ↓ / W S  Velocità    Q / E  Giro    Y  Camera    X / P  Foto    Esc / B  Indietro",
    ]),
    // Going online.
    ...
    ("menu.circuits_keys", ["Stick / D-pad / Arrows / WASD  Browse     PgUp / PgDn  Page     A / Enter  Drive", "Stick / Steuerkreuz / Pfeile / WASD  Blättern     Bild↑ / Bild↓  Seite     A / Enter  Fahren", "Stick / Croix / Flèches / WASD  Parcourir     Pg↑ / Pg↓  Page     A / Entrée  Piloter", "Stick / Cruceta / Flechas / WASD  Explorar     RePág / AvPág  Página     A / Intro  Conducir", "Levetta / Croce / Frecce / WASD  Sfoglia     PagSu / PagGiù  Pagina     A / Invio  Guida"]),
    ("menu.garage_keys", ["↑↓ / W S  Car     ←→ / A D  Setup     Y / M  Mode     A / Enter  Apply", "↑↓ / W S  Auto     ←→ / A D  Setup     Y / M  Modus     A / Enter  Übernehmen", "↑↓ / W S  Voiture     ←→ / A D  Réglage     Y / M  Mode     A / Entrée  Appliquer", "↑↓ / W S  Coche     ←→ / A D  Reglaje     Y / M  Modo     A / Intro  Aplicar", "↑↓ / W S  Auto     ←→ / A D  Assetto     Y / M  Modalità     A / Invio  Applica"]),
    ...
    ("menu.search_empty", ["Search circuits… start typing, or / first", "Strecken suchen… lostippen, oder erst /", "Chercher un circuit… tapez, ou / d'abord", "Buscar circuitos… escribe, o / primero", "Cerca circuiti… scrivi, o prima /"]),
    ...
    ("radio.playing", ["playing", "läuft", "en cours", "sonando", "in onda"]),
    ("radio.connecting", ["connecting", "verbindet", "connexion", "conectando", "connessione"]),
    ("radio.reconnecting", ["reconnecting", "verbindet neu", "reconnexion", "reconectando", "riconnessione"]),
    ...
    ("car.omarchy_tag", ["THE ALL-ROUNDER", "DER ALLROUNDER", "LE POLYVALENT", "EL TODOTERRENO", "IL TUTTOFARE"]),
    ("car.omarchy_about", ["Omarchy Racing’s endurance GT. Good at everything.", "Der Langstrecken-GT von Omarchy Racing. Kann alles.", "La GT d'endurance d'Omarchy Racing. Bonne partout.", "El GT de resistencia de Omarchy Racing. Bueno en todo.", "La GT endurance di Omarchy Racing. Brava ovunque."]),
...
pub(crate) const ACHIEVEMENTS: &[(&str, [&str; 5], [&str; 5])] = &[
    ...
    ("monaco-clean", ["Harbour master", "Hafenmeister", "Capitaine du port", "Capitán del puerto", "Capitano del porto"], ["A lap of Harbour Streets that counts", "Eine gültige Runde auf Harbour Streets", "Un tour valable à Harbour Streets", "Una vuelta válida en Harbour Streets", "Un giro valido a Harbour Streets"]),
    ("suzuka-clean", ["Figure of eight", "Achterbahn", "Le huit", "El ocho", "L'otto"], ["A lap of Figure-Eight Hills that counts", "Eine gültige Runde auf Figure-Eight Hills", "Un tour valable à Figure-Eight Hills", "Una vuelta válida en Figure-Eight Hills", "Un giro valido a Figure-Eight Hills"]),
    ("baku-clean", ["Old town", "Altstadt", "Vieille ville", "Casco antiguo", "Città vecchia"], ["A lap of Caspian Old Town that counts", "Eine gültige Runde in Caspian Old Town", "Un tour valable à Caspian Old Town", "Una vuelta válida en Caspian Old Town", "Un giro valido a Caspian Old Town"]),
];
